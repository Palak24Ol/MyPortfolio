...
const PROJECTS = [
  {
  title: 'API Gateway & Analytics Platform',
  path: 'C:\\PALAK\\works\\api-gateway',
  description: 'A production-grade API Gateway with JWT + API key authentication, Redis rate limiting, analytics tracking, and a custom Go-powered database engine with real-time admin dashboard.',
  tags: ['Spring Boot', 'Go', 'Redis', 'PostgreSQL'],
  link: 'https://github.com/Palak24Ol/api-gateway',
  github: 'https://github.com/Palak24Ol/api-gateway',
  color: 'var(--olive)',
  emoji: '⚡',
  ...
  {
  title: 'TrackMyMoney',
  path: 'C:\\PALAK\\works\\trackmymoney',
  description: 'A full-stack personal finance management system with JWT authentication, email verification, expense tracking, and Excel-based financial report exports.',
  tags: ['Spring Boot', 'Java', 'React', 'MySQL'],
  link: 'https://github.com/Palak24Ol/money-manager-fullstack-project',
  github: 'https://github.com/Palak24Ol/money-manager-fullstack-project',
  color: 'var(--pink-accent)',
  emoji: '💰',
  image: '/projects/trackmymoney.png',
},
  {
  title: 'MockMate',
  path: 'C:\\PALAK\\works\\mockmate',
  description: 'An AI-powered mock interview platform featuring live voice interviews, automated candidate scoring, and real-time feedback generation using Gemini AI and VAPI.',
  tags: ['Next.js', 'TypeScript', 'Firebase', 'Gemini AI'],
  link: 'https://github.com/Palak24Ol/AI-INTERVIEW',
  github: 'https://github.com/Palak24Ol/AI-INTERVIEW',
  color: 'var(--amber)',
  emoji: '🎤',
  ...
  {
  title: 'Code Editor',
  path: 'C:\\PALAK\\works\\code-editor',
  description: 'A browser-based code editor with live code execution, syntax highlighting, and a clean developer-focused interface for writing and testing code in real time.',
  tags: ['React', 'JavaScript', 'CodeMirror', 'Frontend'],
  link: 'https://github.com/Palak24Ol/my-code-editor',
  github: 'https://github.com/Palak24Ol/my-code-editor',
...
},
{
  ...
  path: 'C:\\PALAK\\works\\database-engine',
  description: 'A custom database engine built from scratch featuring a B+ Tree index, write-ahead logging (WAL), and a hand-written SQL parser for efficient storage and query execution.',
  tags: ['Go', 'Database Systems', 'B+ Tree', 'SQL Parser'],
  link: 'https://github.com/Palak24Ol/DatabaseEngine',
  github: 'https://github.com/Palak24Ol/DatabaseEngine',
  color: 'var(--pink-accent)',
  emoji: '🗄️',
  image: '/projects/database-engine.png',
},
{
  title: 'AI Question Engine',
  path: 'C:\\PALAK\\works\\ai-question-engine',
  description: 'An AI-powered question generation platform that creates intelligent and dynamic questions using modern AI models with a clean interactive user experience.',
  tags: ['Next.js', 'TypeScript', 'Firebase', 'Gemini AI'],
  link: 'https://github.com/Palak24Ol/ai-question-engine',
  github: 'https://github.com/Palak24Ol/ai-question-engine',
  color: 'var(--amber)',
  emoji: '🧠',
  image: '/projects/ai-question-engine.png',
},
