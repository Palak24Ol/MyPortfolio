...
const TIMELINE = [
  ...
  },
  {
    ...
    org: 'G N National Public School, Gorakhpur',
    period: '2022',
    desc: 'Scored 93.4% in PCM with Computer Science in CBSE Board exams.',
tags: [],
    icon: '📚',
  ...
  },
  {
    ...
    period: '2020',
    desc: 'Scored 95.6% in ICSE Board exams.',
     tags: [],
    icon: '📚',
